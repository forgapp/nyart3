...
const ClientContactInformationEdit = ({ record, handleChange, handleSubmit, handleCancel, handleRecruiterSelect, handleCompanySelect }) => (<form onSubmit={ handleSubmit }>
  <div class="columns">
...
export default ClientContactInformationEdit;
